...
const IntroduceRow = memo(({ loading, visitData }) => (
  <Row gutter={24}>
    <Col {...topColResponsiveProps}>
      <ChartCard
        bordered={false}
        title={<FormattedMessage id="app.analysis.average-score" defaultMessage="Average Score" />}
        action={
          <Tooltip
      ...
      >
        <Trend flag="up" style={{ marginRight: 16 }}>
          <FormattedMessage id="app.analysis.score-add" defaultMessage="增幅" />
          <span className={styles.trendText}>6%</span>
        </Trend>
        <Trend flag="down">
          <FormattedMessage id="app.analysis.score-reduce" defaultMessage="降幅" />
